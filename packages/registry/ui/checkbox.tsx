...
const FILL_CLASSES = {
  ...
  neutral: {
    outer: [
      ...
      'group-focus/checkbox:fill-text-strong-950',
      'group-focus/checkbox:group-data-[state=checked]/checkbox:fill-text-strong-950',
      'group-focus/checkbox:group-data-[state=indeterminate]/checkbox:fill-text-strong-950',
