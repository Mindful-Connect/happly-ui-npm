      ...
      >
        ...
        {showArrow && (
          <PopoverPrimitive.Arrow asChild>
            <div className='border-stroke-soft-200 bg-bg-white-0 size-[11px] -translate-y-[calc(50%+1px)] -rotate-45 rounded-bl-[3px] border [clip-path:polygon(0_100%,0_0,100%_100%)]' />
