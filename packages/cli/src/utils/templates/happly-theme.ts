...
@theme {
  ...
  --shadow-regular-deep:
    0 0 0 1px rgba(14, 18, 27, 0.04),
    0 1px 1px 0.5px rgba(14, 18, 27, 0.04),
    0 3px 3px -1.5px rgba(14, 18, 27, 0.02),
    0 6px 6px -3px rgba(14, 18, 27, 0.04),
    0 12px 12px -6px rgba(14, 18, 27, 0.04),
    0 24px 24px -12px rgba(14, 18, 27, 0.04),
    0 48px 48px -24px rgba(14, 18, 27, 0.04),
    inset 0 -1px 1px -0.5px rgba(14, 18, 27, 0.06);
