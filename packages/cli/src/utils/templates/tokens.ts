...
export const shadows = {
  ...
  'regular-deep':
    '0 0 0 1px rgba(14, 18, 27, 0.04), 0 1px 1px 0.5px rgba(14, 18, 27, 0.04), 0 3px 3px -1.5px rgba(14, 18, 27, 0.02), 0 6px 6px -3px rgba(14, 18, 27, 0.04), 0 12px 12px -6px rgba(14, 18, 27, 0.04), 0 24px 24px -12px rgba(14, 18, 27, 0.04), 0 48px 48px -24px rgba(14, 18, 27, 0.04), inset 0 -1px 1px -0.5px rgba(14, 18, 27, 0.06)',

  // Focus rings: 2px gap + 2px solid ring, ≥3:1 on both page backgrounds
  // (the previous alpha-10/16 rings measured 1.1–1.4:1 — invisible).
  ...
  'complex-7':
    '0 1px 2px 0 rgba(14, 18, 27, 0.24), 0 0 0 1px var(--color-primary-base)',
  'complex-8':
  ...
  'custom-input-active':
    '0 6px 6px -3px rgba(23, 23, 23, 0.02), 0 3px 3px -1.5px rgba(23, 23, 23, 0.04), 0 1px 1px -0.5px rgba(23, 23, 23, 0.04), 0 0 0 1.4px var(--color-primary-base)',

  'gray-shadow': '0 0 0 1px rgba(23, 23, 23, 0.08)',
  'card-raised':
    '0 2px 5px -1px rgba(0, 0, 0, 0.04), 0 12px 40px -8px rgba(0, 0, 0, 0.08), 0 0 0 1px var(--color-bg-white-0), 0 0 0 1.5px var(--color-neutral-alpha-10)',
};
