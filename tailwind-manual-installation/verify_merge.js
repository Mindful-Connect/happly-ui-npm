...
console.log('\nCase 1: User Extends');
console.log(
  'happly-primary exists?',
  !!resolvedExtend.theme.colors['happly-primary'],
  '(Expected: true)'
);
console.log(
  'user-color exists?',
  !!resolvedExtend.theme.colors['user-color'],
  '(Expected: true)'
);
console.log(
  'shared-color value:',
  resolvedExtend.theme.colors['shared-color'],
  '(Expected: user-shared-override)'
);
...
console.log(
  'happly-primary exists?',
  !!resolvedOverride.theme.colors['happly-primary']
);
