  ...
  return (
    ...
    >
      ...
      <input
        ...
        readOnly={readOnly}
        className={cn(
          'h-full w-full flex-1 rounded-l-[10px] border-none bg-transparent px-3 py-2 text-sm ring-0 outline-none placeholder:text-ds-neutral-400 focus:ring-0 focus:outline-none',
