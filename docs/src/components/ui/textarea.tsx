      ...
      <div className='group relative'>
        <textarea
          ...
          className={cn(
            ...
            // base inset ring
            'ring-1 ring-ds-stroke-soft-200 ring-inset',
            ...
            'focus-visible:shadow-button-important-focus focus-visible:ring-1 focus-visible:ring-ds-stroke-strong-950 focus-visible:ring-inset',
            ...
            // placeholder styling
            !disabled &&
              'placeholder:text-ds-soft-400 placeholder:transition placeholder:duration-200 placeholder:ease-out placeholder:select-none hover:placeholder:text-ds-sub-600 focus-visible:placeholder:text-ds-sub-600',
        ...
        {typeof maxLength === 'number' && (
          <span
            className={cn(
              'pointer-events-none absolute right-3 bottom-2 !text-paragraph-xxs',
