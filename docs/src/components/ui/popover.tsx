  ...
  (
    ...
    const content = (
      <PopoverPrimitive.Content
        ...
        className={cn(
          'z-50 w-72 origin-[--radix-popover-content-transform-origin] rounded-2xl border border-ds-soft-200 bg-popover p-2 text-popover-foreground shadow-regular-md outline-none data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95',
          className
        )}
        {...props}
      />
