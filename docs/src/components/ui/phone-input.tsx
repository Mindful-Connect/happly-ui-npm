      ...
      >
        {({ open }) => (
          <>
            <Listbox.Button
              className={cn(
                'relative flex shrink-0 cursor-default items-center gap-x-2 rounded-l-10 border border-transparent border-r-ds-neutral-200 bg-transparent py-2 pr-2.5 pl-2 text-sm whitespace-nowrap focus:outline-none',
