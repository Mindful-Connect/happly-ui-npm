...
const t = (key: string, params?: Record<string, string>) => {
  const translations: Record<string, string> = {
    '_domain.uploadFile.error.fileType':
      'Invalid file type. Accepted: {fileTypes}',
    '_domain.uploadFile.error.fileSize':
      'File size is too large. Max size: {maxSize}',
    '_domain.uploadFile.uploadedOn': 'Uploaded on',
    '_domain.uploadFile.change': 'Change',
    '_domain.uploadFile.image.title':
      'Choose an existing image or upload a new one.',
    '_domain.uploadFile.image.formats':
      'Supported formats: JPG, PNG. Max size: 3MB',
    '_domain.uploadFile.image.recommended.module':
      'Recommended size: 1200 × 675 px (16:9 ratio, horizontal layout)',
    ...
    '_domain.uploadFile.video.title':
      'Choose an existing video file or upload a new one.',
    '_domain.uploadFile.video.formats':
      'Supported formats: MP4, AVI, MOV. Max size: {bytesFormatted}',
    '_domain.uploadFile.video.recommended':
      'Recommended resolution: 1920 × 1080 px (16:9 Full HD)',
    '_domain.uploadFile.video.preview.title.thumbnail': 'Video file',
    '_domain.uploadFile.document.title':
      'Choose an existing file or upload a new one',
    '_domain.uploadFile.document.formats':
    ...
    'programEditor.logo.descr.2':
      'Use a square image (1:1). Best size: 400 × 400 px',
