...
import { usePrimaryColorContext } from '@/app/providers';
...
function HeaderColorPicker() {
  const { color, setColor } = usePrimaryColorContext();
  return <PrimaryColorPicker color={color} onColorChange={setColor} />;
}
