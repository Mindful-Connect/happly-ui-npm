...
import { default as smartMatchingAiMeta, Default as smartMatchingAi_Default, Sizes as smartMatchingAi_Sizes, DebugLayers as smartMatchingAi_DebugLayers, Playground as smartMatchingAi_Playground } from '@/components/ui/smart-matching-ai.stories';
...
export const storyRegistry: Record<string, {
  ...
  'smart-matching-ai': {
    meta: smartMatchingAiMeta,
    stories: {
    'Default': smartMatchingAi_Default,
    'Sizes': smartMatchingAi_Sizes,
    'DebugLayers': smartMatchingAi_DebugLayers,
    'Playground': smartMatchingAi_Playground
    }
  },
  'socials-input': {
